...
Подробная информация находится в [Лимиты запросов API](limity-api.md).
...
| Максимальное количество счетов, которые можно отправить в одном идентификаторе пакета. | 500                                 |
...
| NIP                                    | 300                       | 100                      |
| PESEL                                  | 12                        | 6                        |
| Отпечаток сертификата (fingerprint)    | 12                        | 6                        |
