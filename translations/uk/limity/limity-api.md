...
Особливу увагу система приділяє шаблонам, що вказують на спроби обходу лімітів, наприклад через паралельне та системне використання кількох IP-адрес в рамках одного контексту. Такі дії можуть бути визнані загрозою безпеці.
...
Додатково, завдяки наданим endpoint-ам можна симулювати різні сценарії:
...
| Закриття пакетної сесії | POST /sessions/batch/{referenceNumber}/close | 20 | 40 | 120 |
...
| Закриття інтерактивної сесії | POST /sessions/online/{referenceNumber}/close | 20 | 60 | 240 |
...
У ситуаціях, коли використання інтерактивної сесії є необхідним, а досягнуті ліміти залишаються недостатніми, просимо зв'язатися з відділом підтримки KSeF для індивідуального аналізу та допомоги в підборі рішення.
